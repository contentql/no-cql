          ...
          fields: [
            {
              ...
              admin: {
                ...
                description: 'Network support details (e.g., 5G, 4G LTE)',
              },
            },
            {
              name: 'os',
              ...
              admin: {
                ...
                description: 'Operating system version (e.g., Android 14)',
              },
            },
          ],
        },
          ...
          fields: [
            {
              ...
              admin: {
                ...
                description: 'Graphics processor unit (e.g., Adreno 740)',
              },
            },
          ],
        },
          ...
          fields: [
            {
              ...
              admin: {
                ...
                description: 'Build material (e.g., Glass back, Plastic frame)',
              },
            },
            {
              name: 'waterResistant',
          ...
          fields: [
            {
              ...
              admin: {
                ...
                description: 'Rugged protection features (e.g., MIL-STD-810G)',
              },
            },
            {
              name: 'unlockMethods',
          ...
          fields: [
            {
              ...
              admin: {
                ...
                description: 'Screen resolution (e.g., 2400 x 1080 pixels)',
              },
            },
            {
              name: 'aspectRatio',
          ...
          fields: [
            {
              ...
              admin: {
                ...
                description: 'Whether the display is bezel-less (Yes/No)',
              },
            },
            {
              name: 'pixelDensity',
          ...
          fields: [
            {
              ...
              admin: {
                ...
                description: 'Color gamut support (e.g., 1B colors, DCI-P3)',
              },
            },
            {
              name: 'refreshRate',
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                ...
                description: 'Tech specs like aperture, sensor size, etc.',
              },
            },
          ],
        },
          ...
          fields: [
            {
              ...
              admin: {
                ...
                description: 'Supported photo modes (e.g., Portrait, Panorama)',
              },
            },
            {
              name: 'ois',
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                ...
                description: 'GPS support and tech (e.g., A-GPS, GLONASS)',
              },
            },
          ],
        },
